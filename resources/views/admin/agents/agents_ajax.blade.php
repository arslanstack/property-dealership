    ...
    <div class="modal-body">
        <form id="edit_agent_form" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="name" class="form-control" placeholder="name" value="{{ $agent['name'] }}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="row">
                        <div class="col-sm-10 mr-0 pr-0">
                            <input type="file" name="image" id="agent_img_input" class="form-control" accept="image/*">
                        </div>
